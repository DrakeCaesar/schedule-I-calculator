...
// Calculate final price for a product (e.g., Cocaine) using the resulting effects
const finalPrice = calculateFinalPrice("Cocaine", currentEffects);
console.log("Final Price for Cocaine:", finalPrice);
